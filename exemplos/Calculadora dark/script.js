...
//Seleciona o elemento HTML com id 'inputBox' e armazena-o na variável 'input'
let input = document.getElementById('inputBox');

//Seleciona todos os elemento HTML do tipo button e armazena-o em 'buttin'
let buttons = document.querySelectorAll('button');

//Inicializa uma string vazia para armazenar a entrada do usuario
let string = "";

//Converte a coleção de botões em um array para possamos percorrer sobre eles
...
arr.forEach(button => {
    ...
    button.addEventListener('click',(e) => {
        ...
        //Verfica se o texto dentro do botão clicado é 'AC' (Clear All)
            ...
            string = "";
            //Define o valor da caixa de entrada 'input' como string vazia.
            input.value = string;
        }
